...
# GEOSX_EDIT_START
# Victor: This is adapted from the radius-spack-configs GitHub repo.
#         We're using this since the new 2025.09 packages suite has not been upstreamed to spack yet.
#         See PR: https://github.com/LLNL/radiuss-spack-configs/pull/143
#
# TODO: Delete this file after the new 2025.09 suite becomes available on spack_packages
#
# GEOSX_EDIT_END
# yapf: disable
