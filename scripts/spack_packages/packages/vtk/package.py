...
class Vtk(CMakePackage):
    ...
    # constexpr SurfaceNets tables. A run_before("cmake") edit is skipped on
    # --keep-stage retries and does not change the spec hash.
    patch('nvhpc-surface-nets-ice.patch', when='@9.7.0 %nvhpc')
