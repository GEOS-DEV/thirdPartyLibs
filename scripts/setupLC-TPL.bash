...
./scripts/setupLC-TPL-helper.bash $GEOSX_DIR $INSTALL_DIR quartz clang@14 "srun -N 1 -t 60 -n 1 -A geosecp" $@ &
./scripts/setupLC-TPL-helper.bash $GEOSX_DIR $INSTALL_DIR quartz gcc@12 "srun -N 1 -t 60 -n 1 -A geosecp" $@ &
