...
./scripts/setupLC-TPL-helper.bash $GEOS_DIR $INSTALL_DIR ruby clang-14 "srun -N 1 -t 90 -n 1 -A cbronze" $@ &
./scripts/setupLC-TPL-helper.bash $GEOS_DIR $INSTALL_DIR ruby gcc-12 "srun -N 1 -t 90 -n 1 -A cbronze" $@ &
...
./scripts/setupLC-TPL-helper.bash $GEOS_DIR $INSTALL_DIR lassen clnang-13-cuda-12       "lalloc 1 -qpdebug" $@ &
