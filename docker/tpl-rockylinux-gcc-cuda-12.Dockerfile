...
# Create symlinks to blas/lapack libraries
     ...
     ./scripts/uberenv/uberenv.py \
       --spec "+cuda~uncrustify~openmp~pygeosx cuda_arch=70 %c,cxx,fortran=gcc@13.3.1 ^cuda@12.9.1+allow-unsupported-compilers ^caliper~gotcha~sampler~libunwind~libdw~papi" \
